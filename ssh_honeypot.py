...
funnel_handler = RotatingFileHandler('log_files/cmd_audits.log', maxBytes=2000, backupCount=5)
...
creds_handler = RotatingFileHandler('log_files/creds_audits.log', maxBytes=2000, backupCount=5)
